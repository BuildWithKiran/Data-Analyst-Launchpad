...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu Drawer (using Portal to escape any CSS constraints) */}
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-[var(--border)]">
                <span className="font-semibold" style={{ fontFamily: "Outfit, sans-serif", color: "var(--text-primary)" }}>Menu</span>
                <button
                  className="btn-icon"
